...
";
  ...
  ";
        ...
        if ((isset($context["keywords"]) ? $context["keywords"] : null)) {
            // line 22
            echo "    ";
            echo $this->env->getExtension('translator')->trans("共找到<span>%count%</span>门<span>“%keywords%”</span>相关课程", array("%count%" => (isset($context["count"]) ? $context["count"] : null), "%keywords%" => (isset($context["keywords"]) ? $context["keywords"] : null)));
            echo "
  ";
        } else {
            // line 24
            echo "    ";
            echo $this->env->getExtension('translator')->trans("共找到<span>%count%</span>门课程", array("%count%" => (isset($context["count"]) ? $context["count"] : null)));
            echo "
    ";
        }
        // line 26
    ...
    <ul class=\"nav nav-pills hidden-xs\" role=\"tablist\">
      ...
      ";
        ...
        if ((isset($context["isShowVipSearch"]) ? $context["isShowVipSearch"] : null)) {
            ...
            <a href=\"";
                // line 32
                echo $this->env->getExtension('routing')->getPath("search", array("filter" => "vip"));
                echo "\">";
        ...
        echo "\">
          <a href=\"";
        // line 37
        echo $this->env->getExtension('routing')->getPath("search", array("filter" => "free"));
        echo "\">";
      ...
      <li role=\"presentation\" class=\"";
        ...
        echo "\">
          <a href=\"";
        // line 40
        echo $this->env->getExtension('routing')->getPath("search", array("filter" => "live"));
        echo "\">";
    ...
    <div class=\"btn-group visible-xs\">
      <button type=\"button\" class=\"btn btn-primary dropdown-toggle\" data-toggle=\"dropdown\" aria-expanded=\"false\">";
        // line 44
        echo $this->env->getExtension('topxia_web_twig')->getDictText("searchCourseType", ((array_key_exists("filter", $context)) ? (_twig_default_filter((isset($context["filter"]) ? $context["filter"] : null), "all")) : ("all")));
        echo "
  ...
  <div class=\"course-list\">
    ...
    ";
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("没有搜到相关课程，请换个关键词试试！"), "html", null, true);
            echo "</div>
    ";
        }
        // line 80
