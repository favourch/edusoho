...
class __TwigTemplate_339dc70e9d79cffc64b33aef9442796e49a03afeff21102b9f4f6917da28e33f extends Twig_Template
{
...
(isset($context["type"]) ? $context["type"] : null) == "other")) {
    ...
    // line 25
    public function getorderStatus($__status__ = null)
    {
        $context = $this->env->mergeGlobals(array(
            "status" => $__status__,
            "varargs" => func_num_args() > 1 ? array_slice(func_get_args(), 1) : array(),
