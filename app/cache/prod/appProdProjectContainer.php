...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'edusoho', 'user' => 'esuser', 'password' => 'edusoho', 'charset' => 'UTF8', 'driverOptions' => array(), 'wrapperClass' => 'Topxia\\Service\\Common\\Connection'), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_72894fea0d743c81e96b5a707090502ebb491f2b572da67d810e63e61900ea96');
        return $instance;
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'ndgbftqpl5cc00484swwwsck8c800s8');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $w = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'ndgbftqpl5cc00484swwwsck8c800s8', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    {
        $this->services['session.handler.pdo.connection'] = $instance = new \PDO('mysql:host=127.0.0.1;port=3306;dbname=edusoho', 'esuser', 'edusoho');
    ...
    {
        return $this->services['topxia.twig.file_cache'] = new \Topxia\Service\Common\FilesystemCache($this->targetDirs[1]);
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ndgbftqpl5cc00484swwwsck8c800s8');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_password' => 'edusoho',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'zh_CN',
            'secret' => 'ndgbftqpl5cc00484swwwsck8c800s8',
            'user_partner' => 'none',
            ...
            'kernel.secret' => 'ndgbftqpl5cc00484swwwsck8c800s8',
            ...
            'twig.options' => array(
                ...
                'paths' => array(
                    '/var/www/edusoho/app/../web/customize' => 'customize',
                    '/var/www/edusoho/app/../src/Topxia/WebBundle/Resources/views' => 'topxiaweb',
                    '/var/www/edusoho/app/../web/themes' => 'theme',
                    '/var/www/edusoho/app/../' => 'root',
                ),
